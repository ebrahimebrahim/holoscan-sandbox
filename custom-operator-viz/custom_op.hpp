...
#ifndef HOLOSCAN_OPERATORS_CUSTOM_OP_HPP
#define HOLOSCAN_OPERATORS_CUSTOM_OP_HPP
 ...
 */
class CustomOp : public holoscan::Operator {
 public:
  HOLOSCAN_OPERATOR_FORWARD_ARGS(CustomOp)
...
#endif /* HOLOSCAN_OPERATORS_CUSTOM_OP_HPP */